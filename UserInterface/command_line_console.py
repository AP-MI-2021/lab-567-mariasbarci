    ...
    while True:
        try:
            ...
            if comanda == "help":
                ...
                print("Exemplu: add,1,caiet,roz,10,loc1")
                print("add,2,telefon,negru,1000,loc2")
                ...
                for i in range(len(executa)):
                    ...
                    if comanda_separata[0] == "add":
                        ...
                        lista = adaugare_obiect(id, nume, descriere, pret, locatie, lista)
                        ...
                        pret = float(comanda_separata[4])
                        locatie = comanda_separata[5]
                        lista = modificare_obiect(id, nume, descriere, pret, locatie, lista)
